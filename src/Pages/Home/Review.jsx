    ...
    return (
      <div className="mt-24 mb-24">
        ...
        <div className="md:flex gap-3">
          <div className="container md:flex flex-col w-full max-w-lg p-6 mx-auto mb-5 divide-y bg-[#B81D33] rounded-md text-white">
            ...
            <div className="p-4 space-y-2 text-sm">
              <p>
                ...
                my bedroom. The quality of the work is exceptional, and I can
                not wait to buy more art from your website!
              </p>
            </div>
          </div>
          <div className="container md:flex flex-col w-full max-w-lg p-6 mx-auto mb-5 divide-y bg-[#B81D33] rounded-md text-white">
            ...
            <div className="p-4 space-y-2 text-sm">
              <p>
                ...
                guests over. The buying process was seamless, and the painting
